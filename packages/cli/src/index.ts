...
/**
 * @minions-qa-runs/cli — CLI for Minions Qa-runs
 *
...
import { customTypes } from '@minions-qa-runs/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Qa-runs'));
        console.log(chalk.dim('Test execution records, assertion results, and pass/fail tracking across clawspaces'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-qa-runs/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-qa-runs/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-qa-runs')}`);

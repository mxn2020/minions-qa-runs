# Manual Setup Steps for Minions Qa-runs
...
Go to **GitHub → mxn2020/minions-qa-runs → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-qa-runs` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-qa-runs-web`
- **GitHub repo**: `mxn2020/minions-qa-runs`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `qa-runs.minions.wtf`

### Documentation
- **Netlify site name**: `minions-qa-runs-docs`
- **GitHub repo**: `mxn2020/minions-qa-runs`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `qa-runs.minions.help`

### Blog
- **Netlify site name**: `minions-qa-runs-blog`
- **GitHub repo**: `mxn2020/minions-qa-runs`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `qa-runs.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `qa-runs.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `qa-runs.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `qa-runs.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-qa-runs/sdk`](https://www.npmjs.com/package/@minions-qa-runs/sdk)
- CLI: [`@minions-qa-runs/cli`](https://www.npmjs.com/package/@minions-qa-runs/cli)
...
Your package: [`minions-qa-runs`](https://pypi.org/project/minions-qa-runs/)
...
| Item | Value |
|------|-------|
| Project | `minions-qa-runs` |
| SDK (npm) | `@minions-qa-runs/sdk` |
| CLI (npm) | `@minions-qa-runs/cli` |
| Python (PyPI) | `minions-qa-runs` |
| GitHub | `github.com/mxn2020/minions-qa-runs` |
| Docs domain | `qa-runs.minions.help` |
| Blog domain | `qa-runs.minions.blog` |
| App domain | `qa-runs.minions.wtf` |
